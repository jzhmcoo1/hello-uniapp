  ...
  <view class="container">
    <view class="page-body">
      <view class="wrapper">
        ...
        <view v-if="showEditor" class="editor-wrapper">
          <editor
            id="editor"
            class="ql-container"
            placeholder="开始输入..."
...
export default {
  ...
  onLoad() {
    // #ifndef MP-BAIDU || MP-XHS
    uni.loadFontFace({
      family: "Pacifico",
      source: 'url("https://sungd.github.io/Pacifico.ttf")', // 访问不通
    });
    // #endif
  },
  onReady() {
  ...
  methods: {
    ...
    onEditorReady() {
      ...
      // #ifdef APP-PLUS || MP-WEIXIN || H5 || MP-XHS
      uni
        .createSelectorQuery()
        .select("#editor")
        .context((res) => {
