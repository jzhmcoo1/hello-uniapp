  ...
  <view>
    ...
    <view class="uni-padding-wrap uni-common-mt">
      <view class="animation-element-wrapper">
        <view @transitionend="handleEnd" class="animation-element" :animation="animationData"></view>
      </view>
      <scroll-view class="animation-buttons" scroll-y="true">
        ...
        <button class="animation-button" @tap="rotateAndScale">
          旋转并缩放
        </button>
        <button class="animation-button" @tap="rotateThenScale">
          旋转后缩放
        </button>
        <button class="animation-button" @tap="all">同时展示全部</button>
        <button class="animation-button" @tap="allInQueue">顺序展示全部</button>
        <button class="animation-button animation-button-reset" @tap="reset">
          还原
        </button>
      </scroll-view>
    </view>
